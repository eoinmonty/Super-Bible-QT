...
void   GLWidget::AdvanceBlurTaget() { curBlurTarget = ((curBlurTarget+ 1) %6); }
GLuint GLWidget::GetBlurTarget0(){ return (1 + ((curBlurTarget + 5) %6)); }
GLuint GLWidget::GetBlurTarget1(){ return (1 + ((curBlurTarget + 4) %6)); }
GLuint GLWidget::GetBlurTarget2(){ return (1 + ((curBlurTarget + 3) %6)); }
GLuint GLWidget::GetBlurTarget3(){ return (1 + ((curBlurTarget + 2) %6)); }
GLuint GLWidget::GetBlurTarget4(){ return (1 + ((curBlurTarget + 1) %6)); }
GLuint GLWidget::GetBlurTarget5(){ return (1 + ((curBlurTarget) %6)); }
...
void GLWidget::UpdateFrameCount()
{
...
void GLWidget::SetupBlurProg(void)
{
...
// Draw the scene·
//·
void GLWidget::DrawWorld(GLfloat yRot, GLfloat xPos)
{
    M3DMatrix44f mCamera;
