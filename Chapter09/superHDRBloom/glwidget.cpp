...
void GLWidget::GenerateOrtho2DMat(GLuint imageWidth, GLuint imageHeight)
{
...
bool GLWidget::LoadOpenEXRImage(char *fileName, GLint textureName, GLuint &texWidth, GLuint &texHeight)
{
...
void GLWidget::GenTexCoordOffsets(GLuint width, GLuint height)
{
...
void GLWidget::SetupFlatColorProg(GLfloat *vLightPos, GLfloat *vColor)
{
...
void GLWidget::SetupTexReplaceProg(GLfloat *vLightPos, GLfloat *vColor)
{
