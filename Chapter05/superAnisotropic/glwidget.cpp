...
void GLWidget::createMenus()
{
    ...
    anisotropic_on = new QAction("Aniostropic On", this);
    anisotropic_on->setCheckable(true);
    anisotropic_off = new QAction("Aniostropic Off", this);
    anisotropic_off->setCheckable(true);
    ...
    menuAnisotropic = new QActionGroup(this);
    menuOptions->addAction(anisotropic_on);
    menuOptions->addAction(anisotropic_off);

    nearest->setChecked(true);
    anisotropic_off->setChecked(true);
    ...
    menu.addSeparator();
    menu.addAction(anisotropic_on);
    menu.addAction(anisotropic_off);
...
void GLWidget::contextMenuEvent(QContextMenuEvent *event)
{
    ...
    for(iLoop = 0; iLoop < TEXTURE_COUNT; iLoop++)
    {
        ...
        else if(pItem == anisotropic_on)
        {
            glGetFloatv(GL_MAX_TEXTURE_MAX_ANISOTROPY_EXT, &fLargest);
            glTexParameterf(GL_TEXTURE_2D, GL_TEXTURE_MAX_ANISOTROPY_EXT, fLargest);
        }
        else if(pItem == anisotropic_off)
        {
